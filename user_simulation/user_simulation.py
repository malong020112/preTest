...
assistant = OpenAI(
    api_key="sk-JPWPI3MfofnoO3fBJlc57g2IjlSfRvcSo6uyKbHx38z6XwfM",
    base_url = "https://zjuapi.com/v1"
)

user = OpenAI(
    api_key="sk-AR6sQpeGglrUZdc3vF2h9RK6cVCFeaBD0tpkdTGsFsynjvig",
    base_url = "https://zjuapi.com/v1"
)
...
# 获取所有条目
all_tasks = get_all_tasks_from_jsonl("coldStart_askActively.jsonl")
...
for item in all_tasks:
    ...
    # with open("result4-gemini-prompt2.1", "a", encoding="utf-8") as f:  # 使用追加模式，保留所有对话
    with open("data.jsonl", "a", encoding="utf-8") as f:  # 使用追加模式，保留所有对话
